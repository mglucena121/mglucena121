...
Desenvolvedor Full Stack com foco em aplicações web bem estruturadas e escaláveis.

Atuo no desenvolvimento de interfaces com React e Vue, construção de APIs REST em Node.js e integração com bancos de dados.
Tenho experiência em projetos completos, do back-end ao front-end, priorizando organização, clareza de código e usabilidade.
...
<div align="left">
  <a href="SEU_LINK_PORTFOLIO_AQUI" target="_blank">
    <img src="https://img.shields.io/badge/Portfólio-6C63FF?style=for-the-badge&logo=todoist&logoColor=white" alt="Portfólio" />
  </a>
  <a href="https://www.linkedin.com/in/m%C3%A1rio-gomes-7b59b71b9/" target="_blank">
...
- 📰 **Portal de Notícias**  
  ...
  Back-end com Node.js, API REST e banco de dados 


- 📊 **Conversor de API para Excel**  
  Aplicação desktop em Python com PySide6  
Consumo de API REST e exportação para Excel com Pandas
...
<img align="left" alt="Vue.js" title="Vue.js" width="30px" style="padding-right:10px"
